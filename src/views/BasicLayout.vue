<template>
    <div>
        ...
        <div :class="['inner-con','inner-con-'+sizemark]">
...
<style>
    body{margin: 0;background-color: #F1F7FF;}
    .page-top-bg{position: fixed;height:89px;width: 100%;background-color:#195190;top: 0;left: 0;z-index: -1;}
